...
import com.outlinevpn.IVpnTunnelService;
import com.outlinevpn.TunnelConfig;
import com.outlinevpn.shadowsocks.ShadowsocksConfig;
...
public class VpnTunnelService extends VpnService {
  ...
  private NotificationHandler notificationHandler = new NotificationHandler(0, this, NotificationHandler.class);
  ...
  public void onRevoke() {
    ...
    updateNotification(TunnelStatus.DISCONNECTED);
  ...
  public JSONObject getVPNConfig() throws JSONException  {
    try {
      JSONObject tunnel = tunnelStore.load();
      final JSONObject jsonConfig = tunnel.getJSONObject("config");
      return jsonConfig;
    } catch (JSONException e) {
      LOG.fine("Tunnel config failed");
      throw new JSONException(String.format("Prefix character is out of range"));
    }
  }
  /**
  ...
  private synchronized ErrorCode startTunnel(
    ...
    notificationHandler.notify("VPN Activated","VPN successfully activated!", false, false);
